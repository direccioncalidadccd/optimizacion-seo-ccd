...
const INITIAL_VISIBLE_COLUMNS = ["TipoProducto", "Naturaleza", "Estado", "actions"];
...
interface Props {
    array: TableTipoProducto[];
}

export default function TableTipoProductoComponent({ array }: Props) {
    ...
    const sortedItems = React.useMemo(() => {
        return [...items].sort((a: TableTipoProducto, b: TableTipoProducto) => {
            const first = a[sortDescriptor.column as keyof TableTipoProducto] as number;
            const second = b[sortDescriptor.column as keyof TableTipoProducto] as number;
    ...
    const renderCell = React.useCallback((user: TableTipoProducto, columnKey: React.Key) => {
        const cellValue = user[columnKey as keyof TableTipoProducto];
        ...
        <>
            ...
            >
                ...
                <TableBody emptyContent={"No users found"} items={sortedItems}>
                    {(item: TableTipoProducto) => (
                        <TableRow key={item.IdTipoProducto}>
                            {(columnKey) => (
