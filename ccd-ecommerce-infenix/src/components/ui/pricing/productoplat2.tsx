...
import { useGlobalContext } from '@/app/plataforma/layout';
import { useCourse } from '@/components/provider/providerCurs';

export default function ProductPlatComponent({ array, openSideSheet }: any) {
    ...
    return (
        <>
            <div className='h-full w-full rounded-2xl'>
                <div className="mx-auto   flex flex-col items-center bg-white/20 rounded-xl overflow-hidden">
                    <div className="bg-muted h-[14rem] max-2xl:h-[17rem]  flex w-full flex-col items-center relative cursor-pointer">
                        ...
                        <Button className="text-tiny absolute right-2 top-2 bg-[#007FED] rounded-xl text-white font-semibold" color="primary" radius="none" size="sm">
                            {array.Clasificacion}
                        </Button>
                    </div>
                    <div className="w-[100%] h-[13rem] p-4 flex flex-col justify-between gap-4 bg-black/20 shadow-lg relative  ">
                        ...
                        <div className='flex w-full justify-between'>
                            <div className='flex relative  justify-between'>
                                <Button onClick={Comprar} className="text-tiny flex gap-3 px-5 bg-[#007FED] text-white  w-full min-w-[9rem]" color="primary" radius="sm" size="sm">
                                    <p className='text-sm font-bold text-white '>S/.{array.Precio}</p>
                                </Button>
                            ...
                            <div className='flex  gap-1 justify-end'>
                                {/* <Button className="bg-[#007FED] text-white  text-tiny w-[20%] min-w-[2.3rem]" color="primary" radius="sm" size="sm">
                                    <IoIosHeart className='text-2xl' />
                                </Button> */}
                                {/* <Button
                                    onClick={handleCartToggle} // Alternar el estado // Llama a la función pasada por props
                                    className="bg-[#007FED] text-white  text-tiny w-[20%] min-w-[2.3rem]"
                                    color="primary"
                                    radius="sm"
                                    size="sm"
                                >
                                ...
                                <Button
                                    onClick={() => openSideSheet(array)} // Llama a la función pasada por props
                                    className="bg-[#007FED] text-white  text-tiny w-[20%] min-w-[2.3rem]"
                                    color="primary"
                                    radius="sm"
                                    size="sm"
