...
export default function ImageGridWithLightbox() {
  ...
  const images = [
    ...
    '/Multimedia/Imagen/ccdcorp/corporativas/3.png',
    '/Multimedia/Imagen/ccdcorp/corporativas/6.png',
    '/Multimedia/Imagen/ccdcorp/corporativas/4.png',
    '/Multimedia/Imagen/ccdcorp/corporativas/5.png',
  ...
  return (
    <>
      <div className="w-full flex flex-col items-center">
        <div className="w-[85%] flex max-sm:flex-col gap-6">
          {/* Primer conjunto de imágenes */}
          <div className="w-[33%] max-sm:w-full grid grid-cols-2 gap-4">
